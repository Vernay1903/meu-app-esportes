...
# Lista de Esportes em Ordem Alfabética
lista_esportes = [
    "Artes Marciais (UFC)", "Automobilismo", "Basquete", "Boxe", 
    "Ciclismo", "Futebol", "Futsal", "Handebol", "Natação", 
    "Skate", "Surfe", "Tênis", "Vôlei", "Vôlei de Praia"
]
...
# Você pode atualizar esses links com os seus cortes favoritos!
videos = {
...
# Exibição do Vídeo Baseado na Escolha
