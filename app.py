...
noticias = {
    ...
    "🏀 Basquete": {"titulo": "NBA: Astro marca 50 pontos", "texto": "Uma performance dominante garantiu a vitória e colocou o time como o principal favorito."},
...
# Agenda do Dia (Apenas Texto - Sem menus de seleção)
...
# Menu de Notícias (Radio - Estilo Foto 1)
st.sidebar.markdown("### 📰 Notícias")
st.sidebar.write("Navegue pelos esportes:")
# Ordem alfabética rigorosa sem o item "Outros"
opcoes_ordenadas = sorted(list(noticias.keys()))
escolha = st.sidebar.radio("Categorias:", opcoes_ordenadas, label_visibility="collapsed")

st.sidebar.write("---")

# Sobre Nós (Texto Fixo)
